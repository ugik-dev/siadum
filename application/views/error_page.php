...
<body>
    ...
    <div class="page-wrapper compact-wrapper" id="pageWrapper">
        ...
        <div class="error-wrapper">
            <div class="container">
                <img class="img-100" src="<?= base_url() ?>assets/images/other-images/sad.png" alt="" />
                <div class="error-heading">
                    <h2 class="headline font-warning">401</h2>
                </div>
                <div class="col-md-8 offset-md-2">
                    <p class="sub-content">
                        Halaman yang Anda coba jangkau saat ini tidak tersedia.<br>
                        Ini mungkin karena halaman tidak ada atau telah dipindahkan.
                    </p>
                </div>
                <div>
