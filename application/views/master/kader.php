                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <input type="text" placeholder="ex. 1986XX XXXXXX X XXX" class="form-control" id="nik" name="nik">
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="form-group">
                                <label for="nama">Jabatan</label>
                                <input type="text" placeholder="" class="form-control" id="jabatan" name="jabatan" value="Kader">
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="form-group">
                                <label for="alamat">Alamat</label>
                                <input type="text" placeholder="" class="form-control" id="alamat" name="alamat">
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="form-group">
                        ...
                        <div class="col-lg-6">
                            <div class="form-group">
                                <label for="tmt_kerja">TMT Aktif</label>
                        ...
                        <div class="col-lg-4">
                            <div class="form-group">
                                ...
                                <input type="text" placeholder="ex. 0812797223XXX" class="form-control" id="no_hp" name="no_hp">
                            </div>
                        </div>
                        <div class="col-lg-4">
                            <div class="form-group">
...
<script>
    $(document).ready(function() {
        ...
        function getAllUser() {
            ...
            Swal.showLoading()
            return $.ajax({
                url: `<?php echo site_url('General/getAllKader/') ?>`,
                'type': 'POST',
      ...
      `;
                ...
                renderData.push([user['id'], user['username'], user['nama'], user['nik'], user['nama_satuan'] + ',<br>' + (user['nama_bag'] ? user['nama_bag'] : ''), user['nama_role'], button]);
            });
