        ...
        <form id="user_form" onsubmit="return false;" type="multipart" autocomplete="off">
            ...
            <div class="modal-body">
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <div class="col-form-label">Tanggal Cuti</div>
                        <div class="row">
                            <div class="col">
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="col-lg-12">
                                <div class="col-form-label">Pengaju Cuti</div>
                                <select class="select2 col-sm-12" id="id_pegawai" name="id_pegawai">
                                    <?php
                                    if (!empty($dataContent['return_data']['id_pegawai'])) {
                                        echo '<option selected value="' . $dataContent['return_data']['id_pegawai'] . '">' . $dataContent['return_data']['nama_penilai'] . '</option>';
                                    }
                                    ?>
                                </select>
                            </div>
                            <div class="col-lg-12">
                                <div class="col-form-label">Atasan </div>
                                <select class="select2 col-sm-12" id="id_atasan" name="id_atasan">
                                    <?php
                                    if (!empty($dataContent['return_data']['id_atasan'])) {
                                        echo '<option selected value="' . $dataContent['return_data']['id_atasan'] . '">' . $dataContent['return_data']['nama_penilai'] . '</option>';
                                    }
                                    ?>
                                </select>
                            </div>
